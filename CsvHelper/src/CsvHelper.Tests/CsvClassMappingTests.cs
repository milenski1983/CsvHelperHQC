...
namespace CsvHelper.Tests
{
    ...
    public class CsvClassMappingTests
    {
        ...
        private sealed class TestMappingConstructorClass : CsvClassMap<TestClass>
        {
            ...
            {
                this.ConstructUsing(() => new TestClass("String Column"));
            }
        }
        ...
        private sealed class TestMappingIndexClass : CsvClassMap<TestClass>
        {
            ...
            {
                this.Map(m => m.GuidColumn).Index(3);
                this.Map(m => m.IntColumn).Index(2);
        ...
        private sealed class TestMappingIngoreClass : CsvClassMap<TestClass>
        {
            ...
            {
                this.Map(m => m.GuidColumn).Ignore();
                this.Map(m => m.IntColumn);
                this.Map(m => m.StringColumn).Ignore();
            }
        }
        ...
        private sealed class TestMappingTypeConverterClass : CsvClassMap<TestClass>
        {
            ...
            {
                this.Map(m => m.GuidColumn).TypeConverter<Int16Converter>();
                this.Map(m => m.IntColumn).TypeConverter<StringConverter>();
                this.Map(m => m.StringColumn).TypeConverter(new Int64Converter());
            }
        }
        ...
        private sealed class TestMappingMultipleNamesClass : CsvClassMap<TestClass>
        {
            ...
            {
                this.Map(m => m.GuidColumn).Name("guid1", "guid2", "guid3");
