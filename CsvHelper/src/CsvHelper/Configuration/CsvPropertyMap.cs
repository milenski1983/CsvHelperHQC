...
namespace CsvHelper.Configuration
{
    ...
    public class CsvPropertyMap
    {
        ...
        {
            this.TypeConverter(ReflectionHelper.CreateInstance<T>());
            return this;
        }
        ...
        {
            this.data.ConvertExpression = (Expression<Func<ICsvReaderRow, T>>)(x => convertExpression(x));
            return this;
        }
        ...
        {
            this.data.TypeConverterOptions.DateTimeStyle = dateTimeStyle;
            return this;
        }
        ...
        {
            this.data.TypeConverterOptions.NumberStyle = numberStyle;
            return this;
        }
